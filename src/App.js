...
import Addusers from './components/AxiosComponents/Addusers';
import Alluser from './components/AxiosComponents/Alluser';
  ...
  <BrowserRouter>
    <Sidebar/>
     <Routes>
      ...
      <Route path='/firstadd-user' element={
      ...
      <Route path='/add-people' element={<Addusers/>}/>
      <Route path='/add-people/:id' element={<Addusers/>}/>
